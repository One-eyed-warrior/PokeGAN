...
[UPDATE] 5/5/24: Getting more or less desirable results, changed the Network architecture by a lot, ran the code on a kaggle notebook using a T4 GPU X2 for about 500 epochs.
...
some sample outputs from the current state of this code: (you can view the gif inside of the notebook) 
